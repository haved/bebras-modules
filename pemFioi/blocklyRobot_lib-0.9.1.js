   ...
   var localLanguageStrings = {
      ...
      no: {
         label: {
            wait: "vent",
            right: "snu til høyre",
            left: "snu til venstre",
            forward: "beveg forover",
            turnAround: "snu rundt",
            jump: "hopp",
            down: "gå ned",
            east: "beveg til høyre",
            south: "beveg nedover",
            west: "beveg til venstre",
            north: "beveg oppover",
            paint: "fargelegg",
            pickTransportable: "plukk opp kulen",
            dropTransportable: "slipp kulen",
            onTransportable: "på en kule",
            onRoundObject: "på en rund gjenstand",
            onSquareObject: "på en firkantet gjenstand",
            onTriangleObject: "på en trekantet gjenstand",
            onDottedObject: "på en prikket gjenstand",
            onFullObject: "på en hel gjenstand",
            onStripedObject: "på en stripete gjenstand",
            onHole: "på et hull",
            transportableShape: "shape of the object",
            transportableColor: "color of the object",
            transportableRed:  "the object is red",
            ...
            gridEdgeEast: "edge of the grid on the right",
            gridEdgeWest: "edge of the grid on the left",
            obstacleInFront: "hinder foran",
            obstacleRight: "hinder til høyre",
            obstacleLeft: "hinder til venstre",
            obstacleEast: "hinder til høyre",
            obstacleWest: "hinder til venstre",
            obstacleNorth: "hinder over",
            obstacleSouth: "hinder under",
            paintInFront: "paint in front",
            paintOnCell: "paint on this cell",
            paintNorthWest: "paint above and to the left",
            paintNorth: "paint above",
         ...
         messages: {
            nothingToPickUp: "Ingenting å plukke opp",
            alreadyTransporting: "Roboten holder allerede en gjenstand",
            notTransporting: "Roboten skal slippe en gjenstand, men den holder ingen.",
            successDroppedAllObjects: "Gratulerer, du har plassert alle gjenstandene!",
            successMarkersPainted: "Gratulerer, roboten har farget alle markørene!",
            failureMarkersPainted: "Roboten har ikke fargelagt riktig.",
            successPickedAllCollectibles: "Gratulerer, roboten har plukket opp alle gjenstandene!",
            failurePickedAllCollectibles: "Roboten har ikke plukket opp alle gjenstandene.",
            successReachGeenArea: "Gratulerer, roboten har nådd det grønne området!",
            failureReachGeenArea: "Roboten har ikke nådd det grønne området.",
            successOneMarbleInHole: "Gratulerer, du har plassert kulen i hullet!",
            successAllMarblesInHoles: "Gratulerer, du har plassert alle kulene i hullene!",
            failureOneMarbleInHole: "Kulen er ikke i hullet.",
            failureAllMarblesInHoles: "Noen kuler er ikke i hull.",
            leavesGrid: "Roboten kan ikke forlate rutenettet."
         },
         description: {
            platformAbove: "plateformeAuDessus() : y a-t-il une plateforme au dessus du robot ?",
            obstacleInFront: "obstacleDevant() : y a-t-il un obstacle devant le robot ?",
          ...
          obstacle: "Roboten har kræsjet i et hinder!",
         startingBlockName: "Program",
         exit_grid: "Le robot sort de la grille !",
         nothingToPickUp: "Rien à ramasser",
         alreadyTransportingObject: "Le robot transporte déjà un objet",
