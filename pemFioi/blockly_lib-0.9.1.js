...
var localLanguageStrings = {
   ...
   no: {
      ...
      download: "last ned",
      smallestOfTwoNumbers: "Minste av de to tallene",
      greatestOfTwoNumbers: "Største av de to tallene",
      programOfRobot: "Robotens program",
      flagClicked: "Når %1 klikkes",
      tooManyIterations: "For mange iterasjoner!",
      tooManyIterationsWithoutAction: "For mange iterasjoner uten handling!",
      submitProgram: "Validater programmet",
      runProgram: "Kjør programmet",
      errorEmptyProgram: "Programmet ditt er tomt. Kobl sammen noen blokker.",
      speed: "Hastighet:",
      stopProgram: "|<",
      stepProgram: "|>",
      slowSpeed: ">",
      ...
      fastSpeed: ">>>",
      ludicrousSpeed: ">|",
      stopProgramDesc: "Omstart fra begynnelsen",
      stepProgramDesc: "Kjør ett steg",
      slowSpeedDesc: "Kjør på denne testen",
      mediumSpeedDesc: "Middels hastighet",
      fastSpeedDesc: "Rask hastighet",
      ludicrousSpeedDesc: "Latterlig hastighet",
      selectLanguage: "Språk :",
      blocklyLanguage: "Blockly",
      javascriptLanguage: "Javascript",
      importFromBlockly: "Generer fra blockly",
      saveOrLoadProgram: "Lagre eller gjenopprett din kode:",
      avoidReloadingOtherTask: "Advarsel: ikke gjenopprett kode som tilhører en annen oppgave!",
      reloadProgram: "Reload:",
      saveProgram: "Lagre",
      ...
      emptyProgram: "Programmet er tomt! Sett sammen noen blokker.",
      tooManyBlocks: "Du bruker for mange blokker!",
      uninitializedVar: "Variablen er ikke initiert:",
      valueTrue: 'sann',
      valueFalse: 'usann',
      correctAnswer: 'Riktig svar',
      partialAnswer: 'Delvis svar',
