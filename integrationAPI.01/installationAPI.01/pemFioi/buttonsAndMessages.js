...
window.displayHelper = {
   ...
   languageStrings: {
      ...
      no: {
         version: "Versjon",
         levelVersionName_easy: "enkel versjon",
         levelVersionName_medium: "middels versjon",
         levelVersionName_hard: "vanskelig versjoner",
         levelVersionName_easy_stars: "2-stjerners versjon",
         levelVersionName_medium_stars: "3-stjerners versjon",
         levelVersionName_hard_stars: "4-stjerners versjon",
         levelName_easy: "Enkel",
         levelName_medium: "Middels",
         levelName_hard: "Vanskelig",
         warningTimeout: "<p>Advarsel: det er mer enn {0} minutter siden du begynte på denne oppgaven.</p><p>Du bør vurdere å bytte til en annen oppgave ved å trykke på knappen øverst til høyre</p>",
         alright: "OK",
         moveOn: "Fortsett",
         solvedMoveOn: "Du har løst denne oppgaven fulstendig. Gå videre til en annen oppgave.",
         confirmRestart: "Er du sikker på at du vil starte på nytt på denne versjonen?",
         yes: "Ja",
         no: "Nei",
         tryHardLevel: "Vi foreslår at du prøver deg på 4-stjerners versjonen.",
         tryMediumLevel: "Vi foreslår at du prøver deg på 3-stjerners versjonen.",
         tryNextTask: "Vi foreslår at du prøver deg på neste oppgave. Dersom du har tid kan du komme tilbake senere og prøve deg på neste versjon av denne oppgaven.",
         yourScoreIsNow: "Din peongsum er nå:",
         worseScoreStays: "Dette er ikke like bra som før. Din poengsum er fortsatt:",
         scoreStays: "Din poengsum er fortsatt:",
         score: "Poengsum:",
         noPointsForLevel: "Du har ikke fått noen poeng enda på denne versjonen.",
         outOf: " ut av ",
         tryToDoBetterOrChangeTask: "Prøv å gjøre det bedre, eller gå videre til en annen oppgave.",
         tryToDoBetterOrMoveToNextLevel: "Prøv å gjøre det bedre, eller gå videre til en vanskeligere versjon av denne oppgaven.",
         bestPossibleScoreCongrats: "Dette er beste mulige poengsum på denne oppgaven. Gratulerer!",
         forMorePointsMoveToNextLevel: "For å få flere poeng, prøv deg på en vanskeligere versjon av denne oppgaven.",
         youDidBetterBefore: "You did better before.",
         scoreStays2: "Your score stays the same.",
         reloadBestAnswer: "Reload your best answer.",
         validate: "Valider",
         restart: "Start på nytt",
         harderLevelSolved: "Advarsel: du har allerede løst en vanskeligere versjon av denne oppgaven. Du vil ikke få flere poeng av å løse denne versjonen.",
         showLevelAnyway: "Vis meg den alikevel.",
         scoreObtained: "Poengsum:",
         hardVersionTakesTime: "Å løse {0} kan ta mye tid. Vurder å jobbe med {1} for å få poeng raskere.",
         illKeepThatInMind: "I'll consider it.",
         harderLevelAvailable: "Note that for this task, you may try to directly work on a harder version than this one.",
         lockedLevel: "This version is locked. Solve the previous version to display it!",
